...
class Seismic3DStreamerShotGathersTemplate(AbstractDatasetTemplate):
    ...
    def _add_coordinates(self) -> None:
        ...
        # For 3D coordinates (over shot_point, cable, channel)
        ...
        self._builder.add_coordinate(
            ...
            data_type=ScalarType.FLOAT64,
            compressor=compressor,
            metadata=VariableMetadata(units_v1=self.get_unit_by_key("group_coord_x"), chunk_grid=chunk_grid_3d),
        )
        self._builder.add_coordinate(
            "group_coord_y",
            dimensions=("shot_point", "cable", "channel"),
            data_type=ScalarType.FLOAT64,
            compressor=compressor,
            metadata=VariableMetadata(units_v1=self.get_unit_by_key("group_coord_y"), chunk_grid=chunk_grid_3d),
        )
