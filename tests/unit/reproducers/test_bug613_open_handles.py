...
class TestBug613HandlesNotClosed: # pragma: no cover - coverage does not apply to tests
    ...
    To run this test,
    1. you need to a google cloud storage bucket (see `gs_file` below)
    2. Login to google `gcloud auth application-default login`


    zarr: 3.1.2
    Issue Link: https://github.com/TGSAI/mdio-python/issues/613
    Reproducer Link: https://github.com/zarr-developers/zarr-python/issues/3487
    """
