...
class TestDimension:
    ...
    def test_hash_equality(self, my_dimension):
...
class TestExceptions:
    ...
    def test_wrong_type_equals(self, my_dimension):
        """Wrong type."""
