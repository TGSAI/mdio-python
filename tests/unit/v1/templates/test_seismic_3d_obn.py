...
# Typical OBN survey dimensions: 4 components, 500 receivers, 10 shot lines, 2 guns, 200 shot points, 4096 samples
DATASET_SIZE_MAP = {"component": 4, "receiver": 500, "shot_line": 10, "gun": 2, "shot_point": 200, "time": 4096}
DATASET_DTYPE_MAP = {
    "component": "uint8",
    "receiver": "uint32",
    "shot_line": "uint32",
...
def _validate_coordinates_headers_trace_mask(dataset: Dataset, headers: StructuredType, domain: str) -> None:
    ...
    # Verify source coordinate variables (indexed by shot_line, gun, shot_point)
...
class TestSeismic3DObnReceiverGathersTemplate:
    ...
    def test_configuration(self) -> None:
        ...
        assert t._dim_names == ("component", "receiver", "shot_line", "gun", "shot_point", "time")
        ...
        assert t._var_chunk_shape == (4, 8, 1, 2, 8, 4096)
    ...
    def test_chunk_size_calculation(self) -> None:
        ...
        The chunk shape (4, 8, 1, 2, 8, 4096) produces:
        4 * 8 * 1 * 2 * 8 * 4096 = 2,097,152 samples.
        ...
        assert chunk_shape == (4, 8, 1, 2, 8, 4096)
    ...
    def test_isometric_chunking(self) -> None:
        ...
        # Extract chunk sizes for receiver and shot_point
        # Dimensions: (component, receiver, shot_line, gun, shot_point, time)
        chunk_shape = t._var_chunk_shape
        receiver_chunk = chunk_shape[1]  # receiver
        shot_point_chunk = chunk_shape[4]  # shot_point

        # Both should be equal for isometric access between receiver and shot domains
        assert receiver_chunk == shot_point_chunk == 8
    ...
    def test_build_dataset(self, structured_headers: StructuredType) -> None:
        ...
        assert seismic.metadata.chunk_grid.configuration.chunk_shape == (4, 8, 1, 2, 8, 4096)
    ...
    def test_depth_domain(self, structured_headers: StructuredType) -> None:
        ...
        assert t._dim_names == ("component", "receiver", "shot_line", "gun", "shot_point", "depth")
