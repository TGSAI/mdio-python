...
EXPECTED_DEFAULT_TEMPLATE_NAMES = [
    ...
    "CdpOffsetGathers2DDepth",
    "CdpAngleGathers2DTime",
    ...
    "ObnContinuousReceiverGathers3D",
    "ShotReceiverLineGathers3D",
]

# Number of built-in templates registered by `_register_default_templates`.
...
class TestTemplateRegistrySingleton:
    ...
    def test_list_all_templates(self) -> None:
        ...
        assert len(templates) == NUM_DEFAULT_TEMPLATES + 2  # default + 2 custom
    ...
    def test_clear_templates(self) -> None:
        ...
        assert len(registry.list_all_templates()) == NUM_DEFAULT_TEMPLATES + 2  # default + 2 custom
...
class TestConcurrentAccess:
    ...
    def test_concurrent_registration(self) -> None:
        ...
        assert len(registry.list_all_templates()) == NUM_DEFAULT_TEMPLATES + 10  # default + 10 registered
